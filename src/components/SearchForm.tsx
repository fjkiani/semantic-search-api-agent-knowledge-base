...
interface EnhancedSearchFormProps {
  ...
  enableHierarchicalView?: boolean;
}
...
const EnhancedSearchForm: React.FC<EnhancedSearchFormProps> = ({
  ...
  const renderResultView = () => {
    if (enableGraphView) {
      return <GraphVisualizer results={results} />;
    }
    if (enableHierarchicalView) {
      return <HierarchicalView results={results} />;
    }
    return <StandardResultView results={results} />;
  };
